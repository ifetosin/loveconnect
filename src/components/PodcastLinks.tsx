    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
          Join our growing community across all platforms. New episodes every
          week filled with wisdom, stories, and practical advice for your
            ...
            return (
              ...
              >
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                  <div
                    className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r ${gradient} rounded-full mb-6 group-hover:animate-pulse`}
                  >
                  ...
                  <p className="text-gray-600 mb-4">
                    {link.platform === "YouTube" &&
                      "Watch full video episodes with visual content"}
                    {link.platform === "Spotify" &&
                      "Listen to audio episodes on the go"}
                    {link.platform === "Instagram" &&
                      "Inspiring posts and community updates"}
                  </p>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            Subscribe on your favorite platform to get notified when new
            episodes drop. Join thousands of listeners growing in love and faith
            together.
          </p>
